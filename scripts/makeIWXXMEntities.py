...
#header_all = ('@prefix owl:   <http://www.w3.org/2002/07/owl#> .\n'
...
header_collection = ('@prefix skos:  <http://www.w3.org/2004/02/skos/core#> .\n'
                     '@prefix rdfs:  <http://www.w3.org/2000/01/rdf-schema#> .\n'
                     '@prefix dct:   <http://purl.org/dc/terms/> .\n'
                     '@prefix reg:   <http://purl.org/linked-data/registry#> .\n'
                     '@prefix ldp:   <http://www.w3.org/ns/ldp#> .\n')

header_entity = ('@prefix skos:  <http://www.w3.org/2004/02/skos/core#> .\n'
                 '@prefix rdfs:  <http://www.w3.org/2000/01/rdf-schema#> .\n'
                 '@prefix dct:   <http://purl.org/dc/terms/> .\n'
                 '@prefix reg:   <http://purl.org/linked-data/registry#> .\n')
