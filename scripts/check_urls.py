    ...
    def make_another_test(infile):
        ...
        def entity_consistent(self):
            ...
            if splitID.startswith('_'):
                expected_rdfgraph.remove((rdflib.term.URIRef(identityURI), None, None))
                expected_rdfgraph.remove((None, rdflib.term.URIRef('http://purl.org/linked-data/registry#entity'), None))
                expected_rdfgraph.remove((None, rdflib.term.URIRef('http://purl.org/linked-data/registry#sourceGraph'), None))
